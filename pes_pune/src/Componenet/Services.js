    ...
    <div style={containerStyle}>
      ...
      <div style={contentStyle}>
        <Grid container spacing={2}>
              ...
              <Grid item xs={12} sm={6} md={3}>
                <div style={gridItemStyle}>
                  ...
                  <b style={{ marginTop: "-14px" }}>
                    Installations and Commissioning of HVAC system{" "}
                  </b>
              ...
              <Grid item xs={12} sm={6} md={3}>
                <div style={gridItemStyle}>
                  ...
                  <b style={{ marginTop: "1px" }}>
                    Installation and Commissioning of Solar Roof Top{" "}
                  </b>
            ...
            return (
              <Grid item xs={12} sm={6} md={3}>
                <div style={gridItemStyle}>
                  ...
                  />
                  <b style={{ marginTop: "10px" }}>
                    Installation and Commissioning of Solar Water heater{" "}
                  </b>

                  <div style={{ marginTop: "25px" }}>
                    "Efficient solar water heater installation and commissioning
                    for sustainable and reliable performance."
                  </div>
                  <button
                    style={{
                      marginTop: "35px",
              ...
              <Grid item xs={12} sm={6} md={3}>
                <div style={gridItemStyle}>
                  ...
                  <b style={{ marginTop: "30px" }}>
                    Installation and Commissioning of Heat Pump{" "}
                  </b>
          ...
          {Object.keys(serviceData9).map((key) => {
            const data = serviceData9[key];
            return (
              <Grid item xs={12} sm={6} md={3}>
                <div style={gridItemStyle}>
                  <img
                  ...
                  <div style={{ marginTop: "25px" }}>
                    "Specialized supply of electric panels and APFC units for
                    efficient and reliable power distribution solutions."
                  </div>
                  <button
                    style={{
                      marginTop: "35px",
          ...
          {Object.keys(serviceData10).map((key) => {
            const data = serviceData10[key];
            return (
              <Grid item xs={12} sm={6} md={3}>
                <div style={gridItemStyle}>
                  <img
                  ...
                  />
                  <b style={{ marginTop: "20px" }}>Electrical Safety Audit</b>

                  <div style={{ marginTop: "25px" }}>
                    "Ensures safe electrical practices, identifying hazards and
          ...
          {Object.keys(serviceData11).map((key) => {
            const data = serviceData11[key];
            return (
              <Grid item xs={12} sm={6} md={3}>
                <div style={gridItemStyle}>
                  <img
                  ...
                  />
                  <b style={{ marginTop: "10px" }}>
                    Supply of Domestic Air-Conditioners{" "}
                  </b>

                  <div style={{ marginTop: "25px" }}>
                    "Reliable supply of domestic air conditioners for efficient
                    and comfortable home cooling."
                  </div>
                  <button
                    style={{
                      marginTop: "35px",
          ...
          {Object.keys(serviceData12).map((key) => {
            const data = serviceData12[key];
            return (
              <Grid item xs={12} sm={6} md={3}>
                <div style={gridItemStyle}>
                  <img
                    src={Img12}
                    alt="Service Image"
                    style={{ ...imageStyle, maxWidth: "70%" }}
                  />
                  <b style={{ marginTop: "10px" }}>
                    Spares and Parts of HVAC System{" "}
                  </b>

                  <div style={{ marginTop: "25px" }}>
                    "Supplying HVAC system spares and parts for efficient and
                    reliable operations."
                  </div>
                  <button
                    style={{
